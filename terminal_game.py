...
def first_decision():
    ...
    while True:
        ...
        if choice == "1":
            ...
            type_text("Dr. Crook sighs. 'AHEM, didn't I JUST say... 'interesting VITALS'?! Time is of the essence, doctor.'")
            player["reputation"] -= 5
            continue
        elif choice == "3":
            type_text("Dr. Crook blocks your path.")
            type_text("'Perhaps some... pertinent information first?'")
            player["anxiety"] += 10
            continue
        elif choice == "4":
            type_text("*Your typing intensifies nervously*")
            type_text("Dr. Crook: 'I can see you typing 'HELP' repeatedly.'")
            type_text("'And is that... Zelda you're playing on an emulator?'")
            player["anxiety"] += 20
            player["reputation"] -= 10
            continue
        else:
            type_text("Dr. Crook frowns. 'That wasn't one of the options, doctor.'")
...
def second_decision():
    ...
    type_text("Dr. Crook taps his pen thoughtfully. 'So, given these vital signs...'")
    ...
    while True:
        ...
        if choice == "1":
            type_text("'Ah, finally asking the right questions!' Dr. Crook's eyes light up.")
            ...
            type_text("Dr. Crook: 'Your phone's UpToDate history is... interesting.'")
            type_text("'Let me see... ah yes, \"help attending scary BP high\" - very professional.'")
            player["anxiety"] += 15
            continue
        elif choice == "3":
            type_text("Dr. Crook physically blocks your path to the button.")
            type_text("'Let's not alert the ENTIRE HOSPITAL just yet, shall we?'")
            player["anxiety"] += 25
            player["reputation"] -= 15
            continue
        elif choice == "4":
            type_text("Dr. Crook's eyebrow raises to previously unknown heights.")
            ...
            type_text("Dr. Crook: 'That wasn't one of the options. Again.'")
...
def third_decision():
    ...
    type_text("Dr. Crook hands you the patient's chart.")
    ...
    while True:
        ...
        if choice == "1":
            ...
            type_text("Dr. Crook tilts his head. 'Not entirely off base, but perhaps premature.'")
            ...
            type_text("Dr. Crook sighs. 'Please choose from the options provided.'")
...
def final_diagnosis():
    ...
    while True:
        ...
        if choice == "1":
            ...
            type_text("Dr. Crook's face falls. 'Really? With those metanephrine levels?'")
            type_text("'Perhaps reconsider the episodic nature and catecholamine excess?'")
            player["reputation"] -= 10
            continue
        elif choice == "3":
            type_text("Dr. Crook shakes his head. 'Close, but not quite right.'")
            type_text("'Conn's would typically present with hypokalemia and wouldn't explain the episodic symptoms.'")
            continue
        elif choice == "4":
            type_text("Dr. Crook sighs deeply. 'Indecisiveness is not a virtue in medicine.'")
...
def end_game(win=False):
    ...
    if win:
        ...
        type_text("Dr. Crook nods approvingly. 'Well done. I'll schedule the patient for an adrenalectomy.'")
...
def start_game():
    ...
    print_divider()
    type_text("🏥 Welcome to ddxCROOK: A Terminal Adventure 🏥")
    ...
    type_text("👨‍⚕️ Dr. Crook appears suddenly behind you!")
