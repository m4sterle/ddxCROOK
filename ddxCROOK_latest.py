...
def end_game(win=False):
    ...
    # Clinical pearls that would only be shown at the end (optional - can be uncommented)
    """
    # Only show clinical pearls AFTER the game as an educational summary
    clinical_pearls = [
